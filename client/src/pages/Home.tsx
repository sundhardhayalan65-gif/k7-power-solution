...
import { fadeUp, fadeIn, stagger, staggerFast, scaleUp, slideLeft, slideRight, viewport } from "@/lib/animations";
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      >
        ...
        <div className="container relative">
          <motion.div
            className="max-w-2xl pb-14 md:pb-20 space-y-6"
            initial="hidden"
            animate="visible"
            variants={stagger}
          >
            ...
            <motion.div
              variants={fadeUp}
              className="inline-flex items-center gap-2 bg-orange-500/15 border border-orange-500/30 text-orange-400 text-xs font-semibold px-3 py-1.5 rounded-full"
            >
              <span className="w-2 h-2 rounded-full bg-orange-400 animate-pulse" />
              Same-day service available today — limited slots
            </motion.div>

            <motion.h1 variants={fadeUp} className="text-white leading-[1.1]">
            ...
            <motion.div variants={staggerFast} className="flex flex-wrap gap-2 pt-2">
              {trustBadges.map(({ icon: Icon, text }) => (
                <motion.div
                  ...
                  className="flex items-center gap-2 bg-white/8 border border-white/10 rounded-lg px-3 py-2 text-xs font-medium text-slate-300 backdrop-blur-sm cursor-default"
                >
        ...
        <div className="border-t border-slate-700/60 bg-slate-900/60">
          <div className="container">
            ...
            >
              {stats.map((stat, i) => (
                <motion.div key={i} variants={fadeUp} className="py-6 px-4 text-center">
      ...
      <section id="services" className="py-20 md:py-28 bg-white" aria-label="Inverter and Battery Services Puducherry">
        <div className="container">
          <motion.div
            ...
            variants={stagger}
          >
            <motion.span variants={fadeUp} className="section-label mb-3">Inverter & Battery Services in Puducherry</motion.span>
            <motion.h2 variants={fadeUp} className="mt-3 mb-4">Every Power Problem in Puducherry. One Number.</motion.h2>
            <motion.p variants={fadeUp} className="text-gray-500 max-w-xl">
          ...
          >
            {services.map(({ icon: Icon, title, description, cta }, i) => (
              <motion.div
                ...
                className="service-card group bg-white border border-gray-100 rounded-xl p-6 shadow-sm flex flex-col"
              >
          ...
          <motion.div
            ...
            viewport={viewport}
            variants={fadeUp}
            className="mt-14 rounded-2xl bg-slate-50 border border-slate-100 p-7 md:p-9 flex flex-col md:flex-row items-center justify-between gap-6"
          >
            <div>
      ...
      <section className="py-20 md:py-28 bg-blue-700" aria-label="Why Choose K7 Power Solution Puducherry">
        <div className="container">
          <motion.div
            ...
            variants={stagger}
          >
            <motion.span variants={fadeUp} className="section-label !text-blue-300 before:bg-blue-300 mb-3">Why Puducherry Chooses Us</motion.span>
            <motion.h2 variants={fadeUp} className="mt-3 mb-4 text-white">Our Promise to Every Puducherry Customer</motion.h2>
            <motion.p variants={fadeUp} className="text-blue-100 max-w-xl">
          ...
          >
            {guarantees.map(({ icon: Icon, title, text }, i) => (
              <motion.div
                key={i}
                variants={fadeUp}
                whileHover={{ y: -5, backgroundColor: "rgba(255,255,255,0.18)" }}
                transition={{ type: "spring", stiffness: 350, damping: 22 }}
      ...
      <section className="py-20 md:py-28 bg-gray-50" aria-label="Customer Reviews Puducherry">
        <div className="container">
          <motion.div
            ...
            variants={stagger}
          >
            <motion.span variants={fadeUp} className="section-label mb-3">Puducherry Customer Reviews</motion.span>
            <motion.h2 variants={fadeUp} className="mt-3 mb-4">What Puducherry Customers Say About Us</motion.h2>
            <motion.p variants={fadeUp} className="text-gray-500 max-w-xl">Real reviews from homeowners and businesses across Puducherry who trust K7 Power Solution.</motion.p>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={viewport}
            variants={scaleUp}
            className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 bg-white border border-gray-100 rounded-2xl p-6 shadow-sm max-w-lg mx-auto"
          >
      ...
      <section id="process" className="py-20 md:py-28 bg-white">
        <div className="container">
          <motion.div
            ...
            variants={stagger}
          >
            <motion.span variants={fadeUp} className="section-label mb-3">How It Works</motion.span>
            <motion.h2 variants={fadeUp} className="mt-3 mb-4">From Your Call to Job Done — Fast</motion.h2>
            <motion.p variants={fadeUp} className="text-gray-500 max-w-xl">
          ...
          >
            {processSteps.map((step, i) => (
              ...
              >
                <motion.div
                  whileHover={{ scale: 1.1, borderColor: "#3b82f6", backgroundColor: "#eff6ff" }}
                  transition={{ type: "spring", stiffness: 400, damping: 20 }}
                  className="shrink-0 w-12 h-12 rounded-full border-2 border-blue-200 bg-blue-50 flex items-center justify-center"
                >
      ...
      <section id="brands" className="py-20 md:py-28 bg-slate-50" aria-label="Authorised Battery and Inverter Brands Puducherry">
        <div className="container">
          <motion.div
            ...
            variants={stagger}
          >
            <motion.span variants={fadeUp} className="section-label mb-3">Authorised Dealer in Puducherry</motion.span>
            <motion.h2 variants={fadeUp} className="mt-3 mb-4">Inverter & Battery Brands We Stock in Puducherry</motion.h2>
            <motion.p variants={fadeUp} className="text-gray-500 max-w-xl">
          ...
          >
            {brands.map((brand, i) => (
              <motion.div
                key={i}
                variants={fadeUp}
                whileHover={{ y: -4, borderColor: "#93c5fd", backgroundColor: "#eff6ff", boxShadow: "0 8px 24px -8px rgba(59,130,246,0.2)" }}
                transition={{ type: "spring", stiffness: 400, damping: 22 }}
                className="group border border-gray-200 bg-white rounded-xl py-7 px-4 text-center shadow-sm cursor-default"
              >
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <motion.div
              ...
              viewport={viewport}
              variants={slideRight}
              className="bg-slate-50 border border-gray-100 rounded-2xl shadow-sm p-7"
            >
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <motion.div
              ...
              variants={stagger}
            >
              <motion.span variants={fadeUp} className="section-label mb-3 mx-auto">Common Questions</motion.span>
              <motion.h2 variants={fadeUp} className="mt-3 mb-4">Frequently Asked Questions</motion.h2>
            ...
            >
              {faqs.map((faq, i) => (
                <motion.div
                  ...
                  whileHover={{ boxShadow: "0 4px 16px -4px rgba(0,0,0,0.08)" }}
                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className="shrink-0"
                    >
                      <ChevronDown className={`w-5 h-5 transition-colors ${openFaq === i ? "text-blue-600" : "text-gray-400 group-hover:text-blue-600"}`} />
                    </motion.div>
                  </button>
      ...
      {/* ─── FOOTER ───────────────────────────────────────────────── */}
      <motion.footer
        className="bg-[#080f1e] text-slate-400"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={fadeIn}
